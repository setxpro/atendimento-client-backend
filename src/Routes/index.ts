...
import { createUserController, deleteUserController, findAllUsersController, findOndeUserController, updateUserController } from "../Controllers/UserController";
...
router.get("/find-one-user/:id", findOndeUserController)
